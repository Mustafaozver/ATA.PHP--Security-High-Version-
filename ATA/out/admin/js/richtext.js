...
Html2Xhtml.isEmptyAttr = {
    'checked' : 1, 'compact' : 1, 'declare' : 1, 'defer' : 1, 'disabled' : 1, 'ismap' : 1, 'multiple' : 1, 'noresize' : 1, 'nosave' : 1, 'noshade' : 1, 'nowrap' : 1, 'readonly' : 1, 'selected' : 1
};
...
function rteInsertHTML(html) {
    document.getElementById(rteName).contentWindow.document.body.innerHTML += "" + html + "";
};
...
function initRTE(rtePreloadContent, rteCSS) {
    if (!document.designMode) {
        ...
        document.write('	border:1px solid transparent;');
        document.write('	cursor:default;');
        document.write('}');
        ...
        document.write('<table style="width:' + rteWidth + ';" cellpadding="0" cellspacing="0">');
        document.write('  <tr>');
        ...
        document.write('        <td ibackground="' + rteImagePath + 'bg.gif" id="rteformat">');
        ...
        document.write('        <td ibackground="' + rteImagePath + 'bg.gif" id="rtefontface">');
        ...
        document.write('        </td>');
        document.write('        <td class="rtebg"><img src="' + rteImagePath + 'blank.gif"></td>');
        document.write('        <td ibackground="' + rteImagePath + 'bg.gif" id="rtefontsize">');
        ...
        document.write('        		</tr>');
        document.write('        	</table>');
        document.write('		<div id="fontcolor3" class="rtedropdown7" style="position:absolute;display:none;padding:4px;">');
        ...
        document.write('		<iframe name="' + rteName + '" id="' + rteName + '" style="width:100%; height:' + rteHeight + '; background-color:#FFFFFF;border:1px solid #a0a0a0;" frameborder="0"></iframe>');
        ...
        document.write('  </tr>');
        document.write('  <tr>');
        document.write('    <td bgcolor="#FFFFFF" height="25" class="rtebg">');
        ...
        if (rteDesignMode) {
            ...
            document.write('							<td style="display:none;color:#000000; font-family:arial; font-size:11px;"><div class="rtebtn9" id="rte_design_mode"><img src="' + rteImagePath + 'design.gif">&nbsp;Düzenle</div></td>');
        }
        if (rteCodeMode) {
        ...
        if (rtePreviewMode) {
            document.write('							<td style="color:#000000; font-family:arial; font-size:11px;"><div class="rtebtn6" id="rte_preview_mode" onclick="rteModeType(\'rte_preview_mode\');"><img src="' + rteImagePath + 'preview.gif">&nbsp;View</div></td>');
        }
        else {
